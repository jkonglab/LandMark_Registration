    ...
    xmlFile=[baseName '.xml'];
        ...
        if num~=0
           ...
           for iTen=1:10                       
               ...
               cRow=cRowShk*10+minRowTmp;  % amplify 10 times at y axis
               cCol=cColShk*10+minColTmp;  % amplify 10 times at x axis
               ...
               for i=1:rowNum
                   for j=1:colNum
                      ...
                      objMaskTmp2=objMaskSubRegion(rowStartBlock:rowEndBlock,colStartBlock:colEndBlock);
